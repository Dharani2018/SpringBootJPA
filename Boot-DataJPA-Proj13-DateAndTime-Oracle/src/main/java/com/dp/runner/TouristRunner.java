...
public class TouristRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*try {
			Tourist t=service.saveTourist(new Tourist("Shantha","coorg",LocalDateTime.of(1975, 10, 15, 10, 35),LocalDate.now(),LocalTime.now()));
			System.out.println(t);
		}catch (Exception e) {
			e.printStackTrace();
		}*/
		try {
			System.out.println(service.getTouristAge("Shantha"));
		}catch (Exception e) {
			e.printStackTrace();
		}
	}
